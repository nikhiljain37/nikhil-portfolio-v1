...
export default function MobileMenu({
  ...
  return (
    <motion.div
      ...
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
      className="grid z-10 items-center grid-cols-2 sm:hidden px-6 py-5 fixed top-12 rounded-2xl bg-[#0F172A] max-w-[90%] w-full mt-12 sm:mt-16 shadow-xl"
    >
      <ul
      ...
      <div className="flex flex-col gap-3 z-20 items-center justify-center">
        <Link
          ...
          target="_blank"
          href="https://linkedin.com/in/niikhiljain2003"
        ...
        <div className="flex gap-3 w-full">
          ...
          <Link
            className="p-4 flex justify-center w-full rounded-xl h-fit text-2xl bg-linear-to-r from-[#d9d9d915] to-[#7373731f] std-backdrop-blur"
            target="_blank"
            href="https://linktr.ee/niikhiljain7746"
            data-blobity-radius="10"
          >
            <Icon icon="mdi:link" />
          </Link>
